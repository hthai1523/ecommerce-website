...
function ProductDetail() {
  ...
  const listImages = [
    "https://m.media-amazon.com/images/I/81x+CxxZNnL._AC_SY879_.jpg",
    "https://m.media-amazon.com/images/I/81yG23NA0pL._AC_SY879_.jpg",
    "https://m.media-amazon.com/images/I/81IM6Nupy9L._AC_SY879_.jpg",
    "https://m.media-amazon.com/images/I/71P-honvG4L._AC_SY879_.jpg",
    "https://m.media-amazon.com/images/I/81yG23NA0pL._AC_SY879_.jpg",
    "https://m.media-amazon.com/images/I/81yG23NA0pL._AC_SY879_.jpg",
    "https://m.media-amazon.com/images/I/81yG23NA0pL._AC_SY879_.jpg",
    "https://m.media-amazon.com/images/I/81yG23NA0pL._AC_SY879_.jpg",
      ...
      <div className="flex flex-wrap  gap-5">
        ...
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div>
            ...
            <Button onClick={handleAddToCart} className="mt-10 text-center font-medium text-sm cursor-pointer transition-all bg-transparent border-2 border-solid rounded-lg border-primary text-primary py-3 px-5  hover:bg-primary hover:text-white ">
              ADD TO CART
            </Button>
          </div>
        </div>
