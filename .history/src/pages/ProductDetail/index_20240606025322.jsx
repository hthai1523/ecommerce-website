        ...
        <div className="flex-1 flex flex-col gap-5 w-1/2">
          ...
          <div>
            ...
            <Button
              ...
              className="mt-10 text-center font-medium text-sm  transition-all bg-transparent border-2 border-solid rounded-lg border-primary text-primary py-3 px-5  hover:bg-primary hover:text-white "
            >
              ADD TO CART
            </Button>
          </div>
