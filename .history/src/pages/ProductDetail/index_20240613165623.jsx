    ...
    <div className="lg:mx-25 w-full flex flex-col">
      {isLoading ? (
       ...
       <>
          ...
          <div className="bg-slate-100 w-full py-16 px space-y-4">
            <div className="space-x-6">
              <Button onClick={() => handleChangeMore('description')}  className={`${more === 'description' ? "font-bold" : "font-normal"} text-2xl text-[#696969] transition-[font-weight] duration-300`}>
                Description
              </Button>
              <Button onClick={() => handleChangeMore('reviews')}  className={`${more === 'reviews' ? "font-bold" : "font-normal"} text-2xl text-[#696969] transition-[font-weight] duration-300`}>
              Reviews
              </Button>
            </div>
