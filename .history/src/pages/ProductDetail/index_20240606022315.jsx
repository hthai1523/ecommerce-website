...
function ProductDetail() {
  ...
  return (
    <div className="my-20 mx-25 w-full container">
      <div className="flex md:flex-row lg:flex-row sm:flex-col items-center sm:justify-center flex-wrap w-full">
        <div className="flex overflow-hidden w-1/2 sm:w-full relative">
        ...
        <div className="flex-1 flex flex-col gap-5 w-1/2 sm:w-full">
