        ...
        <>
          ...
          <div className="bg-slate-100 w-full py-16 lg:px-12 md:px-6 sm:px-4 space-y-4">
            ...
            <div className="flex overflow-hidden w-full">
              <div className=" text-gray-400 font-medium text-base w-full">
                <p>{product?.description}</p>
                <ul className="list-disc pl-8">
                  <li>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Ducimus, voluptatibus natus aliquam corrupti, perspiciatis
                    est temporibus quas nam labore dicta in, ipsum doloribus
                    aperiam nostrum sapiente? Sit ex omnis reiciendis?
                  </li>
                  <li>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Ducimus, voluptatibus natus aliquam corrupti, perspiciatis
                    est temporibus quas nam labore dicta in
                  </li>
                  <li>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  </li>
