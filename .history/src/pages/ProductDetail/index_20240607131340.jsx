          ...
          {product?.images.length > 1 && (
            <>
              <div
                ...
                className="absolute top-1/2 left-0 transform -translate-y-1/2 text-2xl text-black font-black bg-gray-200 rounded-full p-2 cursor-pointer hover:scale-110 duration-150 focus:bg-gray-500"
              >
                <FaChevronLeft />
              </div>
              <div
                onClick={handleNextImage}
                className="absolute top-1/2 right-0 transform -translate-y-1/2 text-2xl text-black font-black bg-gray-200 rounded-full p-2 cursor-pointer hover:scale-110 duration-150 focus:bg-gray-500"
              >
                <FaChevronRight />
              </div>
            </>
