       ...
       <>
          ...
          <div className="bg-slate-100 w-full py-16 lg:px-12 md:px-6 sm:px-4 space-y-4">
            <div className="space-x-6">
              <Button onClick={() => handleChangeMore('description')}  className={`${more === 'description' ? "font-bold" : "font-normal"} text-2xl text-[#696969] transition-[font-weight] duration-300 translate-x-[-2]`}>
                Description
              </Button>
              <Button onClick={() => handleChangeMore('reviews')}  className={`${more === 'reviews' ? "font-bold" : "font-normal"} text-2xl text-[#696969] transition-[font-weight] duration-300 translate-x-[-2]`}>
              Reviews
              </Button>
            </div>
