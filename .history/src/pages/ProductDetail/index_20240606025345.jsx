          ...
          <div>
            <div className="flex items-center gap-3">
              <div className="flex flex-row items-center justify-center gap-2 ">
                ...
                <p className="font-normal text-base text-[#16182380] line-through">
            ...
            <div className="my-10 ml-7 text-[#b4b4b4] font-medium text-sm">
              {product.description}
            </div>
            <hr />
            ...
            <Button
              ...
              className="mt-10 text-center font-medium text-sm  transition-all duration-700 bg-transparent border-2 border-solid rounded-lg border-primary text-primary py-3 px-5  hover:bg-primary hover:text-white "
            >
              ADD TO CART
            </Button>
          </div>
