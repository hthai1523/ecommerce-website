    ...
    <div className="my-20 mx-25 w-full">
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex overflow-hidden w-1/2 relative ">
          ...
          <div className="absolute top-[50%] left-[0] translate-y-[-50%]  text-2xl text-black font-black bg-[#EEE] w-fit h-full my-auto cursor-pointer hover:scale-110 duration-150 ">
            <FaChevronLeft />
          </div>
        </div>
