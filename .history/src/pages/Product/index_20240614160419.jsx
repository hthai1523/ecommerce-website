    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center space-y-6 my-4">
          ...
          {filterCategory || <Button onClick={handleViewMore} className="text-center font-medium text-sm cursor-pointer transition border-2 border-solid rounded-md border-primary text-primary py-3 px-5 hover:bg-primary hover:text-white">
            View More
          </Button>}
        </div>
      )}
