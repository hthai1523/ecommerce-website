    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center">
          ...
          <Button onClick={handleViewMore} className="mt-10 text-center font-medium text-sm cursor-pointer transition-all border-2 border-solid rounded-md border-primary text-primary py-3 px-5 hover:bg-primary hover:text-white">
            View More
          </Button>
