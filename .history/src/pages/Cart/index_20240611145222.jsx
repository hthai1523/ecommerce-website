      ...
      <MotionDiv initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="max-w-[470px] w-full rounded border-solid border-2 border-black mt-20 ">
          <div className="p-3 space-y-3">
            ...
            <Button className="text-center font-medium text-sm lg:text-base cursor-pointer border-2 border-solid rounded-lg border-primary text-white py-2 lg:py-3 px-4 lg:px-5 mt-4 bg-primary hover:opacity-70 transition-opacity duration-150 ease-in-out">
              Process to checkout
            </Button>
          </div>
        </div>
