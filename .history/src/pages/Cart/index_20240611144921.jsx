      ...
      <MotionDiv initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="max-w-[470px] w-full rounded border-solid border-2 border-black mt-20 ">
          <div className="p-3 space-y-3">
            ...
            <Button extraClassName="mt-10 text-center font-medium text-sm cursor-pointer transition-all border-2 border-solid rounded-md border-primary text-primary py-3 px-5 hover:bg-primary hover:text-white">
              Process to checkout
            </Button>
          </div>
        </div>
