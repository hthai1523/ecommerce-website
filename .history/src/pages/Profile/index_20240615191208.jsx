      ...
      <div className="w-full space-y-5">
        ...
        >
          ...
          <button
            ...
            className={` p-4 rounded-3xl hover:opacity-70 transition-opacity duration-300 w-1/2 text-white ${isLoading ? 'bg-slate-400' : 'bg-primary '}`}
          >
            {
                true && <ClipLoader loading={isLoading} color="#ADADAD" size={16} />
            }
            Save Changes
          </button>
        </form>
