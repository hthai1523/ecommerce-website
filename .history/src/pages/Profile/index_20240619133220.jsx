  ...
  const handleSubmit = async (e) => {
    ...
    if (valid) {
      try {
        ...
        await updateProfile(user,  {displayName: `${formState.firstName} ${formState.lastName}, phoneNumber: formState.phoneNumber`});
  ...
  const handleLogout = () => {
    ...
    toast.info(
      <div>
        ...
        <button onClick={confirmLogout} className="bg-blue-500 text-white px-4 py-2 rounded">Yes</button>
        <button onClick={() => toast.dismiss()} className="bg-red-500 text-white px-4 py-2 rounded ml-4">No</button>
      </div>,
      {
        position: "top-center",
        autoClose: false,
    ...
    <div className="mt-[102px] w-full space-y-10">
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col space-y-5">
        ...
        <button
          ...
          className={`p-4 rounded-3xl hover:opacity-70 transition-opacity duration-300 w-1/2 md:w-1/4 text-white flex items-center justify-center gap-2 ${
        ...
        <button
          ...
          className={`p-4 rounded-3xl hover:opacity-70 transition-opacity duration-300 w-1/2 md:w-1/4 text-white flex items-center justify-center gap-2 ${
            isLoading ? "bg-slate-400" : "bg-red-500"
          }`}
        >
          {isLoading && (
            <ClipLoader
