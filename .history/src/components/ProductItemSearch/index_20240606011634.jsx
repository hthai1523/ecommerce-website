    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="flex flex-row items-center gap-2">
          <span className="text-xl font-semibold text-primary">{formatCurrentcy(realPrice)}</span>
          <span className="text-base text-[#16182380] line-through">{formatCurrentcy(data.price)}</span>
        </div>
      </div>
    </Link>
  );
