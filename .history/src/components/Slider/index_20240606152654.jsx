...
function Slider() {
  ...
  return (
    <div className="w-full h-[500px] md:h-[700px] lg:h-[1000px] py-16 relative top-3">
      <div
        style={{ backgroundImage: `url(${slides[currentIndex].url})` }}
        className="w-full h-full bg-center bg-contain bg-no-repeat md:bg-cover lg:bg-cover duration-500 group-hover:block"
      ></div>
