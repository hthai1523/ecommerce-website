    ...
    <div className="relative flex flex-col shadow-lg bg-white rounded-2xl cursor-pointer p-4 my-5 mx-auto w-[90%] max-w-[350px] hover:scale-105 duration-300">
      ...
      <div className="w-full flex-1 text-center mt-4 text-black">
        ...
        <Button
          ...
          extraClassName="text-center font-medium text-sm lg:text-base cursor-pointer border-2 border-solid rounded-lg border-primary text-white py-2 lg:py-3 px-4 lg:px-5 mt-4 bg-primary hover:opacity-70 transition-opacity duration-150 ease-in-out"
        >
          ADD TO CART
        </Button>
      </div>
