...
function Card({ data, url }) {
  ...
  return (
    <div className={`${styles.card} relative flex flex-col shadow-lg bg-white rounded-2xl cursor-pointer p-4 my-5 mx-auto w-[90%] max-w-[350px] hover:scale-105 duration-300`}>
      {data.rating > 4.5 && (
