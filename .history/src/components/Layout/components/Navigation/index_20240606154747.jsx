    ...
    <div className="flex items-center justify-around gap-4">
      ...
      {user.userLoggedIn ? (
        ...
        <Link to={routeConfig.login}>
          <Button className="text-center font-medium text-sm lg:text-base cursor-pointer border-2 border-solid rounded-lg border-primary text-white py-2 lg:py-3 px-4 lg:px-5 bg-primary hover:opacity-70">
            Login
          </Button>
        </Link>
      )}
