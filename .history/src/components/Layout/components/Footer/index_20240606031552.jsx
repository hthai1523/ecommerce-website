      ...
      <div className="container mx-auto flex flex-wrap justify-center">
        <div className="w-full lg:w-2/12 md:w-4/12 sm:w-6/12 px-4 mb-10 space-y-5">
          <Link to={routeConfig.home}>
            <div className="text-left text-3xl font-extrabold text-green-500">
              <h1>Golf Shop</h1>
            </div>
          </Link>
        ...
        <div className="w-full lg:w-2/12 md:w-4/12 sm:w-6/12 px-4 mb-10 space-y-5">
          ...
          <ul className="text-[#b4b4b4] space-y-2">
            ...
            <li>
              <a className="hover:text-white transition-colors" href="tel:0964819465">+84 0964819465</a>
            </li>
            <li>
              <a className="hover:text-white transition-colors" href="mailto:hthai1523@mail.com">hthai1523@mail.com</a>
            </li>
          </ul>
        </div>
      </div>
