...
function BlogCard(thumbnail, title) {
  return (
    <div className="flex flex-col space-y-4 w-full rounded-2xl mx-auto hover:scale-105 duration-300 ">
      ...
      />
      <UserPost />
      <p className="text-xl font-normal cursor-pointer hover:underline">Lorem Ipsum Is a Dummy Text Used As The Heading Of a Blog</p>
    </div>
  );
}
